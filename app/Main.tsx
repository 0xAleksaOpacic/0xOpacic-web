    ...
    <>
      <div className="mt-7 flex items-center justify-between space-y-4">
        <div className="space-y-4">
          ...
          <p>
            I'm a software engineer with a strong focus on blockchain protocol. Off the coding
            screen, you'll often find me at conferences, exchanging ideas and constantly extending
            my knowledge.
          </p>
          <Link
            href="/about"
